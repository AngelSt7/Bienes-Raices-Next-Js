...
export const adminFormDataPropertySchema = z.object({
  districtId: z
...
export const adminGetPropertySchema = z.object({
  id: z.number(),
  imageMain: z.string(),
  location: z.string(),
  price: z.number(),
...
export const adminGetDetailsPropertyInModalSchema = z.object({
  id: z.number(),
  location: z.string(),
  price: z.number(),
  imageMain: z.string(),
...
export const adminGetGameByIdSchema = z.object({
...
export const adminGetPropertiesSchema = z.object({
  properties: z.array(adminGetPropertySchema),
  pages: z.number()
})